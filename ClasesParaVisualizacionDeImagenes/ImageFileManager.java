...
/**
 * clase auxiliar que proporciona métodos estáticos para
 * leer un archivo de imagen (en formato JPEG o PNG) de disco y devolverlo en formato ClasesParaVisualizacionDeImagenes.OFImage
 * y luego guardar de nuevo en disco el objeto ClasesParaVisualizacionDeImagenes.OFImage.
 *
