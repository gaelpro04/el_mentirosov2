package ClasesParaVisualizacionDeImagenes;
...
/**
 * ClasesParaVisualizacionDeImagenes.ImageViewer is the main class of the image viewer application. It builds and
...
public class ImageViewer
{
    ...
    /**
     * Create an ClasesParaVisualizacionDeImagenes.ImageViewer show it on screen.
     */
    public ImageViewer()
    {
        currentImage = null;
    ...
    {
        JOptionPane.showMessageDialog(frame,
                "ClasesParaVisualizacionDeImagenes.ImageViewer\n" + VERSION,
                "About ClasesParaVisualizacionDeImagenes.ImageViewer",
    ...
    {
        frame = new JFrame("ClasesParaVisualizacionDeImagenes.ImageViewer");
        makeMenuBar(frame);
    ...
    private void makeMenuBar(JFrame frame)
    {
        ...
        item = new JMenuItem("About ClasesParaVisualizacionDeImagenes.ImageViewer...");
